...
<!--header-center-->
			<div class="header-center">
				...
				<div class="center-right">
					<a href="task8-home.jsp" class="option">首页</a>
					<a href="#" class="option">职业</a>
					<a href="task8-two.jsp" class="option">推荐</a>
					<a href="#" class="option">关于</a>
				</div>
			</div>
<!--header-end-->
			<div class="header-end">
				<a href="task8-home.jsp" class="end-left">首页</a>>
