	...
	<header>
		...
		<div class="header-center">
			...
			<div class="center-right">
				<a href="${pageContext.request.contextPath}/jsp/task8-home.jsp">首页</a>
				<a href="${pageContext.request.contextPath}/jsp/task8-three.jsp">职业</a>
				<a href="${pageContext.request.contextPath}/jsp/task8-two.jsp">推荐</a>
				<a href="#">关于</a>
			</div>
		</div>
	</header>
